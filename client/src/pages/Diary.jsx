...
const API_URL = "https://journly.onrender.com";
...
function Diary() {
  ...
  const fetchEntries = async (dateToFetch) => {
    try {
      const res = await axios.get(
        `${API_URL}/api/diary?date=${dateToFetch.toISOString()}`,
        {
  ...
  const fetchMonthEntries = async (date) => {
    try {
      ...
      const res = await axios.get(
        `${API_URL}/api/diary/month?year=${year}&month=${month}`,
        {
          headers: { Authorization: token },
        }
      );
  ...
  const handleDelete = async (entryId) => {
    ...
    try {
      await axios.delete(`${API_URL}/api/diary/${entryId}`, {
        headers: { Authorization: token },
      });
    ...
    <div className="diary-container">
      <div className="calendar-container">
        ...
        <Calendar
          ...
          tileContent={({ date }) =>
            monthEntries.has(date.toDateString()) ? (
